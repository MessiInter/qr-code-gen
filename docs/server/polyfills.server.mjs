  ...
  let ne = class ne {
    ...
    wrap(i, g) {
      ...
      let k = this._zoneDelegate.intercept(this, i, g),
        z = this;
      return function () {
        return z.runGuarded(k, this, arguments, g);
      };
    }
    run(i, g, k, z) {
      p = { parent: p, zone: this };
      try {
        return this._zoneDelegate.invoke(this, i, g, k, z);
      } finally {
        p = p.parent;
      }
    }
    runGuarded(i, g = null, k, z) {
      p = { parent: p, zone: this };
      try {
        try {
          return this._zoneDelegate.invoke(this, i, g, k, z);
    ...
    runTask(i, g, k) {
      ...
      let z = i.state != Y;
      z && i._transitionTo(Y, J), i.runCount++;
      let Ee = D;
      ...
      try {
        ...
        try {
          ...
          if (this._zoneDelegate.handleError(this, G)) throw G;
        }
      } finally {
        i.state !== m &&
          i.state !== L &&
          (i.type == f || (i.data && i.data.isPeriodic)
            ? z && i._transitionTo(J, Y)
            : ((i.runCount = 0),
              this._updateTaskCount(i, -1),
              z && i._transitionTo(m, Y, m))),
          (p = p.parent),
          (D = Ee);
      }
    }
    ...
    scheduleMicroTask(i, g, k, z) {
      return this.scheduleTask(new E(P, i, g, k, z, void 0));
    }
    scheduleMacroTask(i, g, k, z, Ee) {
      return this.scheduleTask(new E($, i, g, k, z, Ee));
    }
    scheduleEventTask(i, g, k, z, Ee) {
      return this.scheduleTask(new E(f, i, g, k, z, Ee));
    }
    cancelTask(i) {
      if (i.zone != this)
        throw new Error(
    ...
    _updateTaskCount(i, g) {
      ...
      for (let z = 0; z < k.length; z++) k[z]._updateTaskCount(i.type, g);
    }
  };
  ne.__symbol__ = a;
  let l = ne,
    h = {
      ...
      onInvokeTask: (ee, i, g, k, z, Ee) => ee.invokeTask(g, k, z, Ee),
  ...
  class s {
    ...
    _updateTaskCount(i, g) {
      ...
      if (z == 0 || Ee == 0) {
        ...
        this.hasTask(this.zone, G);
      }
    }
  }
  class E {
    constructor(i, g, k, z, Ee, G) {
      if (
        ((this._zone = null),
        (this.runCount = 0),
      ...
      i === f && z && z.useG
        ...
        : (this.invoke = function () {
            return E.invokeTask.call(v, W, this, arguments);
          });
    }
...
var aa = typeof WorkerGlobalScope < 'u' && self instanceof WorkerGlobalScope,
  ia =
    !('nw' in nt) &&
    typeof nt.process < 'u' &&
    {}.toString.call(nt.process) === '[object process]',
  ...
  Wr = {},
  $n = function (v) {
    if (((v = v || nt.event), !v)) return;
    let N = Wr[v.type];
    N || (N = Wr[v.type] = Ue('ON_PROPERTY' + v.type));
    let d = this || v.target || nt,
      u = d[N],
      n;
...
function Jn(v, N, d) {
  ...
  let a = u.get,
    ...
    l = N.slice(2),
    h = Wr[l];
  h || (h = Wr[l] = Ue('ON_PROPERTY' + l)),
    (u.set = function (s) {
      let E = this;
      if ((!E && v === nt && (E = nt), !E)) return;
...
Zone.__load_patch('ZoneAwarePromise', (v, N, d) => {
  ...
  function a(G) {
    if (G && G.toString === Object.prototype.toString) {
      let W = G.constructor && G.constructor.name;
      return (W || '') + ': ' + JSON.stringify(G);
    }
    ...
    if (d.showUncaughtError()) {
      ...
      W
        ? console.error(
            ...
            G.zone.name,
            '; Task:',
            G.task && G.task.source,
            '; Value:',
            W,
            W instanceof Error ? W.stack : void 0
          )
        : console.error(G);
    }
  }),
  ...
  function x(G) {
    ...
    try {
      let W = N[y];
      typeof W == 'function' && W.call(this, G);
    } catch {}
  }
  function R(G) {
    return G && G.then;
  ...
  function r(G, W, H) {
    ...
    if (G[B] === J) {
      ...
      if (
        ...
        D(H), r(G, H[B], H[w]);
      else if (W !== F && typeof le == 'function')
        try {
          le.call(H, X(P(G, W)), X(P(G, !1)));
        } catch (de) {
          X(() => {
            r(G, !1, de);
          })();
        ...
        if (
          ((G[w] = H),
          G[_] === _ && W === Y && ((G[B] = G[m]), (G[w] = G[S])),
          W === F && H instanceof Error)
        ) {
...
` + H.stack
  ...
  function D(G) {
    if (G[B] === L) {
      try {
        ...
        W &&
          typeof W == 'function' &&
          W.call(this, { rejection: G[w], promise: G });
      } catch {}
      G[B] = F;
      for (let W = 0; W < l.length; W++) G === l[W].promise && l.splice(W, 1);
    }
  }
  function O(G, W, H, X, le) {
    D(G);
    let de = G[B],
      se = de
        ? typeof X == 'function'
      ...
      () => {
        try {
          let me = G[w],
            ge = !!H && _ === H[_];
          ge && ((H[S] = me), (H[m] = de));
          let _e = W.run(se, void 0, ge && se !== re && se !== I ? [] : [me]);
          r(H, !0, _e);
        } catch (me) {
          r(H, !1, me);
        }
  ...
  class i {
    ...
    static resolve(W) {
      return r(new this(null), Y, W);
    }
    static reject(W) {
      return r(new this(null), F, W);
    }
    static any(W) {
      if (!W || typeof W[Symbol.iterator] != 'function')
        return Promise.reject(new ee([], 'All promises were rejected'));
      let H = [],
        X = 0;
      try {
        for (let se of W) X++, H.push(i.resolve(se));
      } catch {
        return Promise.reject(new ee([], 'All promises were rejected'));
      }
      if (X === 0)
    ...
    static race(W) {
      ...
      for (let me of W) R(me) || (me = this.resolve(me)), me.then(de, se);
      return le;
    }
    static all(W) {
      return i.allWithCallback(W);
    }
    static allSettled(W) {
      return (this && this.prototype instanceof i ? this : i).allWithCallback(
        W,
        {
          thenCallback: (X) => ({ status: 'fulfilled', value: X }),
          errorCallback: (X) => ({ status: 'rejected', reason: X }),
        }
      );
    }
    static allWithCallback(W, H) {
      let X,
        le,
        de = new this((_e, Ae) => {
          (X = _e), (le = Ae);
      ...
      for (let _e of W) {
        ...
        try {
          _e.then(
            (Me) => {
              (ge[Ae] = H ? H.thenCallback(Me) : Me), se--, se === 0 && X(ge);
            },
            (Me) => {
              H
                ? ((ge[Ae] = H.errorCallback(Me)), se--, se === 0 && X(ge))
                : le(Me);
            }
          );
        } catch (Me) {
    ...
    then(W, H) {
      ...
      (!X || typeof X != 'function') && (X = this.constructor || i);
      let le = new X(ne),
        de = N.current;
      return (
        this[B] == J ? this[w].push(de, le, W, H) : O(this, de, le, W, H), le
      );
    }
    catch(W) {
      ...
      X[_] = _;
      let le = N.current;
      return this[B] == J ? this[w].push(le, X, W, W) : O(this, le, X, W, W), X;
    }
  }
  (i.resolve = i.resolve),
    (i.reject = i.reject),
  ...
  function z(G) {
    ...
    let X = W.then;
    (W[E] = X),
      (G.prototype.then = function (le, de) {
        return new i((me, ge) => {
          X.call(this, me, ge);
        }).then(le, de);
      }),
  ...
  function Ee(G) {
    return function (W, H) {
      ...
      let le = X.constructor;
      return le[k] || z(le), X;
    };
  }
  return (
    g && (z(g), er(v, 'fetch', (G) => Ee(G))),
...
var Zi = { useG: !0 },
  ...
  Wi = Ue('propagationStopped');
function ca(v, N) {
  let d = (N ? N(v) : v) + Rt,
    u = (N ? N(v) : v) + It,
    n = zr + d,
    a = zr + u;
  (rt[v] = {}), (rt[v][Rt] = n), (rt[v][It] = a);
}
function Ki(v, N, d, u) {
  let n = (u && u.add) || ta,
    a = (u && u.rm) || ra,
  ...
  function re(w, _) {
    ...
    let F = _ && _.eventNameToString,
      ...
      o = (Y[Ue(l)] = Y[l]),
      r;
    _ && _.prepend && (r = Y[Ue(_.prepend)] = Y[_.prepend]);
    function p(H, X) {
      return !Jt && typeof H == 'object' && H
        ? !!H.capture
        : !Jt || !X
        ? H
        : typeof H == 'boolean'
    ...
    let D = function (H) {
      ...
      O = function (H) {
        if (!H.isRemoved) {
          let X = rt[H.eventName],
            le;
          X && (le = X[H.capture ? It : Rt]);
      ...
      k = function (H, X) {
        let le = typeof X;
        return (
          (le === 'function' && H.callback === X) ||
          (le === 'object' && H.originalDelegate === X)
        );
      },
      z = _ && _.diff ? _.diff : k,
      Ee = Zone[Ue('UNPATCHED_EVENTS')],
      G = v[Ue('PASSIVE_EVENTS')],
      W = function (H, X, le, de, se = !1, me = !1) {
        return function () {
          let ge = this || v,
            _e = arguments[0];
          ...
          let Ke = Jt && !!G && G.indexOf(_e) !== -1,
            Ze = p(arguments[2], Ke);
          if (Ee) {
            for (let it = 0; it < Ee.length; it++)
              if (_e === Ee[it])
                return Ke ? H.call(ge, _e, Ae, Ze) : H.apply(this, arguments);
          }
          let rr = Ze ? (typeof Ze == 'boolean' ? !0 : Ze.capture) : !1,
            at = Ze && typeof Ze == 'object' ? Ze.once : !1,
            zt = Zone.current,
            Fe = rt[_e];
          Fe || (ca(_e, F), (Fe = rt[_e]));
          let br = Fe[rr ? It : Rt],
          ...
          if (Te) {
            if (((nr = !0), ie)) {
              for (let it = 0; it < Te.length; it++) if (z(Te[it], Ae)) return;
            }
          } else Te = ge[br] = [];
          let Ot,
            Er = ge.constructor.name,
            ar = zi[Er];
          ar && (Ot = ar[_e]),
            Ot || (Ot = Er + X + (F ? F(_e) : _e)),
            (L.options = Ze),
            at && (L.options.once = !1),
            (L.target = ge),
            (L.capture = rr),
          ...
          let _t = S ? Zi : void 0;
          _t && (_t.taskData = L);
          let Ye = zt.scheduleEventTask(Ot, Ae, _t, le, de);
          if (
            ((L.target = null),
            _t && (_t.taskData = null),
            at && (Ze.once = !0),
            (!Jt && typeof Ye.options == 'boolean') || (Ye.options = Ze),
            (Ye.target = ge),
            (Ye.capture = rr),
            (Ye.eventName = _e),
            Me && (Ye.originalDelegate = Ae),
            me ? Te.unshift(Ye) : Te.push(Ye),
            se)
          )
            return ge;
        };
    ...
    return (
      (Y[n] = W(P, s, i, g, J)),
      r && (Y[E] = W(r, b, ne, g, J, !0)),
      (Y[a] = function () {
        let H = this || v,
          X = arguments[0];
        _ && _.transferEventName && (X = _.transferEventName(X));
        let le = arguments[2],
          ...
          for (let Ae = 0; Ae < _e.length; Ae++) {
            ...
            if (z(Me, se)) {
              if (
                ...
                (Me.isRemoved = !0),
                _e.length === 0 &&
                  ((Me.allRemoved = !0), (H[ge] = null), typeof X == 'string'))
              ) {
                let Ke = zr + 'ON_PROPERTY' + X;
                H[Ke] = null;
              }
          ...
          if (le) {
            ...
            if (me) {
              ...
              for (let Ae = 0; Ae < _e.length; Ae++) {
                ...
                this[a].call(this, X, Ke, Me.options);
              }
            }
            if (ge) {
              let _e = ge.slice();
    ...
    'external/npm/node_modules/domino/lib/Document.js'(v, N) {
      ...
      function f(i, g) {
        ...
        return (
          ...
          (z = g),
          (Ee = g.indexOf(':')),
          Ee >= 0 && ((k = g.substring(0, Ee)), (z = g.substring(Ee + 1))),
          ...
          i === J.XMLNS &&
            !(k === 'xmlns' || g === 'xmlns') &&
            m.NamespaceError(),
          { namespace: i, prefix: k, localName: z }
        );
      }
      F.prototype = Object.create(n.prototype, {
        ...
        _dispatchRendererEvent: {
          value: function (i, g, k) {
            var z = this._nodes[i];
            z && z._dispatchEvent(new h(g, k), !0);
          },
        },
...
`
        ...
        cloneNode: {
          value: function (g) {
            ...
            if (g)
              for (var z = this.firstChild; z !== null; z = z.nextSibling)
                k._appendChild(k.importNode(z, !0));
        ...
        addId: {
          value: function (g, k) {
            var z = this.byId[g];
            z
              ? (z instanceof ee || ((z = new ee(z)), (this.byId[g] = z)),
                z.add(k))
              : (this.byId[g] = k);
          },
        },
        delId: {
          value: function (g, k) {
            ...
            m.assert(z),
              z instanceof ee
                ? (z.del(k), z.length === 1 && (this.byId[g] = z.downgrade()))
                : (this.byId[g] = void 0);
          },
        },
        _resolve: {
  ...
  Mn = ue({
    'external/npm/node_modules/domino/lib/HTMLParser.js'(v, N) {
      ...
      var ee = {
        ...
        Ze = /[^\x09\x0A\x0C\x0D\x20]/g,
        rr = /[^\x00\x09\x0A\x0C\x0D\x20]/,
        at = /^[\x09\x0A\x0C\x0D\x20]+/,
        zt = /\x00/g;
      function Fe(U) {
        var V = 16384;
      ...
      (Ne.ElementStack = function () {
        ...
        (Ne.ElementStack.prototype.push = function (U) {
          this.elements.push(U), (this.top = U);
        }),
        (Ne.ElementStack.prototype.pop = function (U) {
          this.elements.pop(),
            (this.top = this.elements[this.elements.length - 1]);
        }),
        (Ne.ElementStack.prototype.popTag = function (U) {
        ...
        (Ne.ElementStack.prototype.popElementType = function (U) {
          for (
        ...
        (Ne.ElementStack.prototype.popElement = function (U) {
          for (
            var V = this.elements.length - 1;
        ...
        (Ne.ElementStack.prototype.removeElement = function (U) {
        ...
        (Ne.ElementStack.prototype.clearToContext = function (U) {
          for (
            var V = this.elements.length - 1;
            V > 0 && !Te(this.elements[V], U);
            V--
          );
          (this.elements.length = V + 1), (this.top = this.elements[V]);
        }),
        (Ne.ElementStack.prototype.contains = function (U) {
          return this.inSpecificScope(U, Object.create(null));
        }),
        (Ne.ElementStack.prototype.inSpecificScope = function (U, V) {
        ...
        (Ne.ElementStack.prototype.elementInSpecificScope = function (U, V) {
          for (var ce = this.elements.length - 1; ce >= 0; ce--) {
            var te = this.elements[ce];
            if (te === U) return !0;
            if (Te(te, V)) return !1;
        ...
        (Ne.ElementStack.prototype.inScope = function (U) {
          return this.inSpecificScope(U, o);
        }),
        (Ne.ElementStack.prototype.elementInScope = function (U) {
          return this.elementInSpecificScope(U, o);
        }),
        (Ne.ElementStack.prototype.elementTypeInScope = function (U) {
          return this.elementTypeInSpecificScope(U, o);
        }),
        (Ne.ElementStack.prototype.inButtonScope = function (U) {
          return this.inSpecificScope(U, p);
        }),
        (Ne.ElementStack.prototype.inListItemScope = function (U) {
          return this.inSpecificScope(U, r);
        }),
        (Ne.ElementStack.prototype.inTableScope = function (U) {
          return this.inSpecificScope(U, D);
        }),
        (Ne.ElementStack.prototype.inSelectScope = function (U) {
          for (var V = this.elements.length - 1; V >= 0; V--) {
            var ce = this.elements[V];
        ...
        (Ne.ElementStack.prototype.generateImpliedEndTags = function (U, V) {
          for (
            ...
            if ((U && Te(Ie, U)) || !Te(this.elements[te], ce)) break;
          }
        ...
        (Ne.ActiveFormattingElements.prototype.push = function (U, V) {
          for (
            var ce = 0, te = this.list.length - 1;
            te >= 0 && this.list[te] !== this.MARKER;
            te--
          )
            if (Ht(U, this.list[te], this.attrs[te]) && (ce++, ce === 3)) {
          ...
          this.attrs.push(Ie);
          function Ht(bt, qt, ut) {
            if (bt.localName !== qt.localName || bt._numattrs !== ut.length)
              return !1;
            for (var ze = 0, vr = ut.length; ze < vr; ze++) {
              var Pt = ut[ze][0],
                A = ut[ze][1];
              if (!bt.hasAttribute(Pt) || bt.getAttribute(Pt) !== A) return !1;
            }
            return !0;
          }
        }),
        ...
        (Ne.ActiveFormattingElements.prototype.findElementByTag = function (U) {
        ...
        (Ne.ActiveFormattingElements.prototype.indexOf = function (U) {
          return this.list.lastIndexOf(U);
        }),
        (Ne.ActiveFormattingElements.prototype.remove = function (U) {
          var V = this.list.lastIndexOf(U);
          V !== -1 && (this.list.splice(V, 1), this.attrs.splice(V, 1));
        }),
        (Ne.ActiveFormattingElements.prototype.replace = function (U, V, ce) {
          var te = this.list.lastIndexOf(U);
          te !== -1 && ((this.list[te] = V), (this.attrs[te] = ce));
        }),
        (Ne.ActiveFormattingElements.prototype.insertAfter = function (U, V) {
      ...
      function Ne(U, V, ce) {
        var te = null,
          ...
          ft = null,
          ht = [],
          C = new Ne.ElementStack(),
          ve = new Ne.ActiveFormattingElements(),
          Bt = V !== void 0,
          wr = null,
          dt = null,
          Nr = !0;
        ...
        if (((Se._parser = kr), (Se._scripting_enabled = Nr), V)) {
          ...
          Se._appendChild(xn),
            C.push(xn),
            V instanceof l.HTMLTemplateElement && ht.push(gn),
            ur();
          for (var ir = V; ir !== null; ir = ir.parentElement)
            if (ir instanceof l.HTMLFormElement) {
              dt = ir;
              break;
            }
        }
        ...
        function Nt(e, t) {
          for (var T = 0; T < et.length; T++) if (et[T][0] === e) return;
          t !== void 0 ? et.push([e, t]) : et.push([e]);
        }
        function xa() {
          Me.lastIndex = ae - 1;
          var e = Me.exec(te);
          ...
          switch (T[0]) {
            ...
            case "'":
              ...
              break;
            default:
              (A = lt), (ae += e[0].length - 1), (T = T.substring(0, M - 1));
              break;
          }
          for (var q = 0; q < et.length; q++) if (et[q][0] === t) return !0;
          return et.push([t, T]), !0;
        }
        function Ia() {
          (yr = !1), (Le = ''), (et.length = 0);
        }
...
` && (e = e.substring(1)),
        ...
        function qa() {
          yr ? Pe(y, Le, null, !0) : Pe(b, Le, et, !0);
        }
        function Ce() {
          Pe(R, Fe(vt), Tt ? Fe(Tt) : void 0, yt ? Fe(yt) : void 0);
        }
        function be() {
          Kt(), j(s), (Se.modclock = 1);
        }
        ...
        function ur() {
          for (var e = !1, t = C.elements.length - 1; t >= 0; t--) {
            var T = C.elements[t];
            if (
              (t === 0 && ((e = !0), Bt && (T = V)), T.namespaceURI === a.HTML)
            ) {
              var M = T.localName;
              switch (M) {
                case 'select':
        ...
        function Ar(e, t) {
          pe(e, t), (A = fr), (ft = j), (j = Ur);
        }
        function Pa(e, t) {
          pe(e, t), (A = Ct), (ft = j), (j = Ur);
        }
        function an(e, t) {
          return {
            elt: lr(e, ve.list[t].localName, ve.attrs[t]),
            attrs: ve.attrs[t],
          };
        }
        function Ge() {
          if (ve.list.length !== 0) {
            ...
            if (e !== ve.MARKER && C.elements.lastIndexOf(e) === -1) {
              for (
                var t = ve.list.length - 2;
                t >= 0 &&
                ((e = ve.list[t]),
                !(e === ve.MARKER || C.elements.lastIndexOf(e) !== -1));
                t--
              );
              for (t = t + 1; t < ve.list.length; t++) {
                var T = Lr(function (M) {
                  return an(M, t).elt;
                });
                ve.list[t] = T;
        ...
        var Mr = { localName: 'BM' };
        function Ba(e) {
          if (Te(C.top, e) && ve.indexOf(C.top) === -1) return C.pop(), !0;
          for (var t = 0; t < 8; ) {
            t++;
            var T = ve.findElementByTag(e);
            if (!T) return !1;
            var M = C.elements.lastIndexOf(T);
            if (M === -1) return ve.remove(T), !0;
            if (!C.elementInScope(T)) return !0;
            for (var q = null, Q, he = M + 1; he < C.elements.length; he++)
              if (Te(C.elements[he], S)) {
            ...
            if (q) {
              ...
              ve.insertAfter(T, Mr);
              for (
                var Re = q, je = q, Je = Q, tt, Zt = 0;
                Zt++, (Re = C.elements[--Je]), Re !== T;

              ) {
                if (
                  ((tt = ve.indexOf(Re)),
                  Zt > 3 && tt !== -1 && (ve.remove(Re), (tt = -1)),
                  tt === -1)
                ) {
                  C.removeElement(Re);
                  continue;
                }
                var xt = an(we.ownerDocument, tt);
                ve.replace(Re, xt.elt, xt.attrs),
                  (C.elements[Je] = xt.elt),
                  (Re = xt.elt),
                  je === q && (ve.remove(Mr), ve.insertAfter(xt.elt, Mr)),
                  Re._appendChild(je),
                  (je = Re);
              }
              kt && Te(we, J)
                ...
                ? we.content._appendChild(je)
                : we._appendChild(je);
              for (
                var pr = an(q.ownerDocument, ve.indexOf(T));
                q.hasChildNodes();

              )
                pr.elt._appendChild(q.firstChild);
              q._appendChild(pr.elt),
                ve.remove(T),
                ve.replace(Mr, pr.elt, pr.attrs),
                C.removeElement(T);
              var Ii = C.elements.lastIndexOf(q);
              C.elements.splice(Ii + 1, 0, pr.elt);
            } else return C.popElement(T), ve.remove(T), !0;
          }
          return !0;
        }
        function Fa() {
        ...
        function Va(e) {
          e === 47 ? (pt(), (A = Ga)) : (K.push(60), oe(e, Ct));
        }
        function Ga(e) {
          switch (e) {
            case 65:
        ...
        function Za(e) {
          ...
          K.push(60), K.push(47), h(K, De), oe(e, Ct);
        }
        function za(e) {
          e === 47 ? (pt(), (A = Wa)) : (K.push(60), oe(e, fr));
        }
        function Wa(e) {
          switch (e) {
            case 65:
        ...
        function Ka(e) {
          ...
          K.push(60), K.push(47), h(K, De), oe(e, fr);
        }
        function Xa(e) {
          switch (e) {
            case 47:
        ...
        function Qa(e) {
          ...
          K.push(60), K.push(47), h(K, De), oe(e, Lt);
        }
        function $a(e) {
          e === 45 ? ((A = Ja), K.push(45)) : oe(e, Lt);
        }
        function Ja(e) {
          e === 45 ? ((A = qn), K.push(45)) : oe(e, Lt);
        }
        function ct(e) {
          switch (e) {
            case 45:
        ...
        function ni(e) {
          switch (e) {
            ...
            case 47:
            case 62:
              Fe(De) === 'script' ? (A = Dt) : (A = ct), K.push(e);
              break;
            case 65:
            case 66:
            case 67:
        ...
        function cn(e) {
          e === 47 ? (pt(), (A = si), K.push(47)) : oe(e, Dt);
        }
        function si(e) {
          switch (e) {
            case 9:
            ...
            case 47:
            case 62:
              Fe(De) === 'script' ? (A = ct) : (A = Dt), K.push(e);
              break;
            case 65:
            case 66:
            case 67:
        ...
        function lt(e) {
          switch (e) {
            ...
            case -1:
              ...
              break;
            case 61:
              tn(), (Xe += String.fromCharCode(e)), (A = ln);
              break;
            default:
              if (xa()) break;
              tn(), oe(e, ln);
        ...
        function ln(e) {
          switch (e) {
            ...
            case 89:
            case 90:
              Xe += String.fromCharCode(e + 32);
              break;
            case 0:
              Xe += String.fromCharCode(65533);
              break;
            case 34:
            case 39:
            case 60:
...
`
        ...
        function pi(e) {
          switch (e) {
            ...
            case -1:
              ...
              break;
            default:
              xe.push(45), xe.push(45), xe.push(33), oe(e, jt);
              break;
          }
        }
        function mi(e) {
        ...
        function Fn(e) {
          switch (e) {
            ...
            case 89:
            case 90:
              Wt(), vt.push(e + 32), (A = hn);
              break;
            case 0:
              Wt(), vt.push(65533), (A = hn);
              break;
            case 62:
              Wt(), ke(), (A = ye), Ce();
              break;
        ...
        function yi(e) {
          switch (e) {
            ...
            case 62:
              ...
              break;
            default:
              K.push(93), K.push(93), oe(e, dn);
              break;
          }
        }
        function hr(e) {
          switch ((pt(), De.push(38), e)) {
            case 9:
            case 10:
            case 12:
            case 32:
        ...
        function zn(e) {
          ...
          switch (((ae += T.length), h(De, br(T)), Et)) {
            case xr:
            case Ir:
            case Rr:
          ...
          pt();
          var M = z[T];
          typeof M == 'number' ? De.push(M) : h(De, M), (A = Vt);
        }
        zn.lookahead = -G;
        function wi(e) {
          switch (((Oe = 0), e)) {
        ...
        function Li(e, t, T, M) {
          switch (e) {
            case 1:
              if (((t = t.replace(at, '')), t.length === 0)) return;
              break;
            case 4:
        ...
        function Wn(e, t, T, M) {
          ...
          switch (e) {
            ...
            case 2:
              if (t === 'html') {
                (q = lr(Se, t, T)), C.push(q), Se.appendChild(q), (j = Fr);
                return;
              }
              break;
            case 3:
        ...
        function qe(e, t, T, M) {
          switch (e) {
            case 1:
              var q = t.match(at);
              if (
                (q && (ot(q[0]), (t = t.substring(q[0].length))),
                t.length === 0)
              )
                return;
              break;
            ...
            case 2:
              switch (t) {
                ...
                case 'script':
                  ...
                  return;
                case 'template':
                  pe(t, T), ve.insertMarker(), (He = !1), (j = gn), ht.push(j);
                  return;
                case 'head':
                  return;
              }
        ...
        function fe(e, t, T, M) {
          ...
          switch (e) {
            case 1:
              if (wt && ((t = t.replace(zt, '')), t.length === 0)) return;
              He && Ke.test(t) && (He = !1), Ge(), ot(t);
              return;
            case 5:
              return;
            case 4:
            ...
            case 2:
              switch (t) {
                ...
                case 'listing':
                  ...
                  return;
                case 'form':
                  if (dt && !C.contains('template')) return;
                  C.inButtonScope('p') && fe(y, 'p'),
                    (we = pe(t, T)),
                    C.contains('template') || (dt = we);
                  return;
                case 'li':
                ...
                case 'a':
                  ...
                  Re && (fe(y, t), ve.remove(Re), C.removeElement(Re));
                case 'b':
                case 'big':
                case 'code':
                case 'em':
                ...
                case 'u':
                  ...
                  return;
                case 'nobr':
                  Ge(), C.inScope(t) && (fe(y, t), Ge()), ve.push(pe(t, T), T);
                  return;
                case 'applet':
                case 'marquee':
                case 'object':
                  Ge(), pe(t, T), ve.insertMarker(), (He = !1);
                  return;
                case 'table':
                ...
                case 'keygen':
                case 'wbr':
                  Ge(), pe(t, T), C.pop(), (He = !1);
                  return;
                case 'input':
                  Ge(), (we = pe(t, T)), C.pop();
                  var je = we.getAttribute('type');
                ...
                case 'image':
                  ...
                  return;
                case 'textarea':
                  pe(t, T), (Ft = !0), (He = !1), (A = Ct), (ft = j), (j = Ur);
                  return;
                case 'xmp':
                  C.inButtonScope('p') && fe(y, 'p'), Ge(), (He = !1), Ar(t, T);
                  return;
                case 'iframe':
                  (He = !1), Ar(t, T);
                  return;
                ...
                case 'option':
                  ...
                  return;
                case 'menuitem':
                  Te(C.top, 'menuitem') && C.pop(), Ge(), pe(t, T);
                  return;
                case 'rb':
                case 'rtc':
                ...
                case 'rt':
                  ...
                  return;
                case 'math':
                  Ge(), _t(T), Ye(T), nn(t, T, a.MATHML), M && C.pop();
                  return;
                case 'svg':
                  Ge(), ar(T), Ye(T), nn(t, T, a.SVG), M && C.pop();
                  return;
                case 'caption':
                case 'col':
                case 'colgroup':
            ...
            case 3:
              switch (t) {
                ...
                case 'form':
                  if (C.contains('template')) {
                    ...
                    var Je = dt;
                    if (((dt = null), !Je || !C.elementInScope(Je))) return;
                ...
                case 'object':
                  if (!C.inScope(t)) return;
                  C.generateImpliedEndTags(), C.popTag(t), ve.clearToMarker();
                  return;
                case 'br':
                  fe(b, t, null);
                  return;
              ...
              for (Q = C.elements.length - 1; Q >= 0; Q--)
                if (((he = C.elements[Q]), Te(he, t))) {
                  C.generateImpliedEndTags(t), C.popElement(he);
                  break;
                } else if (Te(he, S)) return;
              return;
          }
        }
        function Ur(e, t, T, M) {
        ...
        function $e(e, t, T, M) {
          ...
          switch (e) {
            ...
            case 2:
              switch (t) {
                case 'caption':
                  C.clearToContext(L), ve.insertMarker(), pe(t, T), (j = mn);
                  return;
                case 'colgroup':
                ...
                case 'tfoot':
                case 'thead':
                  C.clearToContext(L), pe(t, T), (j = Gt);
                  return;
                case 'td':
                case 'th':
                case 'tr':
        ...
        function Di(e, t, T, M) {
          if (e === E) {
            ...
            var q = Sr.join('');
            (Sr.length = 0),
              Ke.test(q) ? ((kt = !0), fe(E, q), (kt = !1)) : ot(q),
              (j = ft),
              j(e, t, T, M);
          }
        }
        ...
        function jr(e, t, T, M) {
          ...
          Te(C.top, 'colgroup') && (jr(y, 'colgroup'), j(e, t, T, M));
        }
        function Gt(e, t, T, M) {
          function q() {
          ...
          switch (e) {
            case 2:
              switch (t) {
                case 'tr':
                  C.clearToContext(P), pe(t, T), (j = dr);
                  return;
                case 'th':
                case 'td':
                  Gt(b, 'tr', null), j(e, t, T, M);
                  return;
                case 'caption':
                case 'col':
                case 'colgroup':
          ...
          switch (e) {
            case 2:
              switch (t) {
                case 'th':
                case 'td':
                  C.clearToContext($), pe(t, T), (j = Xt), ve.insertMarker();
                  return;
                case 'caption':
                case 'col':
                case 'colgroup':
            ...
            case 2:
              switch (t) {
                ...
                case 'tr':
                  C.inTableScope('td')
                    ? (Xt(y, 'td'), j(e, t, T, M))
                    : C.inTableScope('th') && (Xt(y, 'th'), j(e, t, T, M));
                  return;
              }
              break;
            case 3:
              switch (t) {
                ...
                case 'tr':
                  if (!C.inTableScope(t)) return;
                  Xt(y, C.inTableScope('td') ? 'td' : 'th'), j(e, t, T, M);
                  return;
              }
              break;
          }
            ...
            case 2:
              switch (t) {
                case 'html':
                  ...
                  return;
                case 'option':
                  C.top instanceof l.HTMLOptionElement && gt(y, t), pe(t, T);
                  return;
                case 'optgroup':
                  C.top instanceof l.HTMLOptionElement && gt(y, 'option'),
                    C.top instanceof l.HTMLOptGroupElement && gt(y, t),
                    pe(t, T);
                  return;
                case 'select':
                  gt(y, t);
        ...
        function gn(e, t, T, M) {
          function q(Q) {
            (j = Q), (ht[ht.length - 1] = j), j(e, t, T, M);
          }
          switch (e) {
            case 1:
            case 4:
        ...
        function _n(e, t, T, M) {
          switch (e) {
            case 1:
              (t = t.replace(Ze, '')), t.length > 0 && ot(t);
              return;
            case 4:
              st(t);
              return;
            ...
            case 3:
              if (t === 'frameset') {
                if (Bt && C.top instanceof l.HTMLHtmlElement) return;
                C.pop(),
                  !Bt && !(C.top instanceof l.HTMLFrameSetElement) && (j = Ai);
                return;
              }
              break;
          }
        ...
        function xi(e, t, T, M) {
          switch (e) {
            case 1:
              (t = t.replace(Ze, '')), t.length > 0 && fe(e, t, T, M);
              return;
            case 4:
              Se._appendChild(Se.createComment(t));
              return;
            ...
            case 2:
              switch (t) {
                ...
                case 'var':
                  if (Bt) break;
                  do C.pop(), (Q = C.top);
                  while (Q.namespaceURI !== a.HTML && !nr(Q) && !Ot(Q));
                  Pe(e, t, T, M);
                  return;
              }
              (Q = C.elements.length === 1 && Bt ? V : C.top),
                Q.namespaceURI === a.MATHML
                  ? _t(T)
                  : Q.namespaceURI === a.SVG && ((t = Er(t)), ar(T)),
                Ye(T),
            ...
            if (
              ...
              (Pe = function (he, we, Re, je) {
                switch ((Kt(), he)) {
                  ...
                  case 2:
                    for (
                      var Je = Object.create(null), tt = 0;
                      tt < Re.length;
                      tt++
                    ) {
                      var Zt = Re[tt];
