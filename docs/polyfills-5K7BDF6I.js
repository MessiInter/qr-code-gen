...
function qe(e, n, c) {
  let r = me(e, n);
  if (
    (!r && c && me(c, n) && (r = { enumerable: !0, configurable: !0 }),
    !r || !r.configurable)
  )
    return;
      ...
      (function (a) {
        typeof c[a] == 'function'
          ...
          : Ne(Y[e].prototype, a, {
              set: function (l) {
                typeof l == 'function'
                  ? ((this[ne][a] = Ae(l, e + '.' + a)), ae(this[ne][a], l))
                  : (this[ne][a] = l);
              },
              get: function () {
                return this[ne][a];
  ...
  function te(u) {
    if (u[q] === d) {
      try {
        ...
        f &&
          typeof f == 'function' &&
          f.call(this, { rejection: u[R], promise: u });
      } catch {}
      u[q] = x;
        ...
        a.forEach(function (m) {
          ...
          try {
            if (Z.hasOwnProperty(m)) {
              ...
              O && O.value
                ? ((O.value = e.wrapWithCurrentZone(O.value, I)),
                  e._redefineProperty(b.prototype, m, O))
        ...
        if (typeof I[0] == 'function') {
          ...
          I[0] = function () {
            try {
              ...
              Z.isPeriodic ||
                (typeof Z.handleId == 'number'
                  ? delete y[Z.handleId]
                  : Z.handleId && (Z.handleId[ve] = null));
            }
          };
          ...
          typeof Z == 'number' ? (O = y[Z]) : ((O = Z && Z[ve]), O || (O = Z)),
            O && typeof O.type == 'string'
              ? O.state !== 'notScheduled' &&
                ...
                (typeof Z == 'number' ? delete y[Z] : Z && (Z[ve] = null),
                O.zone.cancelTask(O))
              : k.apply(e, I);
        }
    ));
...
Zone.__load_patch('XHR', (e, n) => {
  ...
  function b(k) {
    ...
    function q(d) {
      ...
      return (
        O.call(P, A, re), P[c] || (P[c] = d), T.apply(P, N.args), (P[l] = !0), d
      );
    }
    function R() {}
    function E(d) {
...
Zone.__load_patch('geolocation', (e) => {
  e.navigator &&
    ...
    lt(e.navigator.geolocation, ['getCurrentPosition', 'watchPosition']);
});
...
//# sourceMappingURL=polyfills-5K7BDF6I.js.map
